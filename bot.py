...
for i in range(1200):
    ...
    for comment in  all_comments:
        if comment.author != "Raymond668bot":
    ...
    if has_not_commented:
        ...
        for comment in not_my_comments:
            ...
            if "Raymond668bot" not in authors:
        ...
        if len(comments_without_replies) >0:
            replysort = sorted(comments_without_replies, key=lambda x:x.score)
            replysort[-1].reply(generate_comment())
            print ('reply to top comment')
